...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator): #########
            ...
            inputs = {"input_ids": batch[0], "input_ids2": batch[1], "attention_mask": batch[2], "labels": batch[4],'ref_to_alt_ids': batch[5]}
            # print('##################',inputs)
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    dataset = TensorDataset(all_input_ids, all_input_ids2, all_attention_mask, all_token_type_ids, all_labels, all_ref_to_alt_ids)
    return dataset
